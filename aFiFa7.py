...
class Lover(telepot.helper.ChatHandler):
    ...
    keyboard9 = InlineKeyboardMarkup(inline_keyboard=[[ #-- Terusan Pengaturan-Takaran dari Menu Awal
                   InlineKeyboardButton(text='Lanjutkan..', callback_data='BB')],[
                   InlineKeyboardButton(text='Batal', callback_data='batal'),
                ]], resize_keyboard=True)
    keyboard10 = InlineKeyboardMarkup(inline_keyboard=[[ #-- Terusan Pengaturan-Takaran dari Menu Awal
...
while True:
    ...
    if (statusP_1 == False and jadwal_1 == now.hour):
        bot.sendMessage(CHATID, 'Pemberian Pakan pada semua Kolam 1 akan dilakukan Lanjutkan ? \n Aku akan melanjutkannya secara automatis jika Anda tidak membatalkanya..', parse_mode='html', reply_markup=keyboard9)
        status_1 = True
        on_callback_query('', 'BB')
    if (statusP_2 == False and jadwal_2 == now.hour):
        bot.sendMessage(CHATID, 'Pemberian Pakan pada semua Kolam 2 akan dilakukan Lanjutkan ? \n Aku akan melanjutkannya secara automatis jika Anda tidak membatalkanya..', parse_mode='html', reply_markup=keyboard9)
        status_2 = True
    if (statusP_3 == False and jadwal_3 == now.hour):
        bot.sendMessage(CHATID, 'Pemberian Pakan pada semua Kolam 3 akan dilakukan Lanjutkan ? \n Aku akan melanjutkannya secara automatis jika Anda tidak membatalkanya..', parse_mode='html', reply_markup=keyboard9)
        status_3 = True
