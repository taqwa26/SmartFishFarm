...
class Lover(telepot.helper.ChatHandler):
    ...
    def on_chat_message(self, msg):
        ...
        #== Bagian Beri Pakan ==
        ...
        elif (command == 'Lanjutkan..' and statusO_3 == True):
            statusO_3 = False
            ...
            self._editor = telepot.helper.Editor(self.bot, sent)
            self._edit_msg_ident = telepot.message_identifier(sent)
        elif (command == 'Batalkan..' and statusO_3 == True):
            statusO_3 = False
            if status_1 :
                status_1 = False
                statusP_1 = True
    ...
    def on__idle(self, event):
        ...
        global status_3
        global status_4
        if status_1 or status_2 or status_3 or status_4 and statusO_3 == False:
            status_1 = False
            status_2 = False
            status_3 = False
            status_4 = False
...
while True:
    ...
    if jadwal_1 != jadwal_2 != jadwal_3 and statusO_2 :
    ...
    elif jadwal_1 == jadwal_2 != jadwal_3 and statusO_2 :
        if (statusP_1 == False and jadwal_1 == now.hour):
            statusO_3 = True
            status_1 = True
            status_2 = True
        ...
        if (statusP_1 == False and jadwal_1 == now.hour):
            ...
            if(statusO_1):
                ...
                bot.sendMessage(CHATID, 'Pemberian Pakan pada Kolam 1 telah dilakukan secara otomatis')
                statusP_1 = True
    elif jadwal_1 == jadwal_3 != jadwal_2 and statusO_2 :
        if (statusP_1 == False and jadwal_1 == now.hour):
            statusO_3 = True
            status_1 = True
            status_3 = True
